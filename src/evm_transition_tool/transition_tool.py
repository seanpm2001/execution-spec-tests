    ...
    def evaluate(
        ...
        *,
        ...
        if self.t8n_use_stream:
            return self._evaluateStream(alloc=alloc, txs=txs, env=env, fork_name=fork_name, chain_id=chain_id, reward=reward, eips=eips, debug_output_path=debug_output_path)
        else:
            return self._evaluateFilesystem(alloc=alloc, txs=txs, env=env, fork_name=fork_name, chain_id=chain_id, reward=reward, eips=eips, debug_output_path=debug_output_path)
