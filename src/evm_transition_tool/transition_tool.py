...
from .transition_tool_methods._filesystem import _dump_files_to_directory
...
def dump_files_to_directory(output_path: str, files: Dict[str, Any]) -> None:
    ...
    """
    _dump_files_to_directory(str, files)
...
class TransitionTool:
    ...
    from .transition_tool_methods._evaluate import _evaluate_filesystem
    from .transition_tool_methods._evaluate import _evaluate_stream
